CLASS ztest_class_sk DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZTEST_CLASS_SK IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    CONSTANTS lc_class_name        TYPE cl_apj_dt_create_content=>ty_class_name    VALUE 'ZCL_TEST_JOB'.
    ...
    CONSTANTS lc_transport_request TYPE cl_apj_dt_create_content=>ty_transport_request VALUE 'TRLK903119'.
    CONSTANTS lc_package           TYPE cl_apj_dt_create_content=>ty_package           VALUE 'ZTEST_SK'.
    ...
    NEW zcl_test_job( )->if_apj_dt_exec_object~get_parameters(
      IMPORTING
